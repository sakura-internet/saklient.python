...
class Model_IsoImage(Model):
    ...
    def _create_resource_impl(self, obj, wrapped=False):
        ...
        return IsoImage(self._client, obj, wrapped)
    
    ## 次に取得するリストの開始オフセットを指定します。
    # 
    # @param {int} offset オフセット
    # @return {saklient.cloud.models.model_isoimage.Model_IsoImage} this
    ...
    # 
    # @return {saklient.cloud.resources.isoimage.IsoImage} リソースオブジェクト
    def create(self):
        return self._create()
    ...
    # 
    # @return {saklient.cloud.resources.isoimage.IsoImage[]} リソースオブジェクトの配列
    def find(self):
        return self._find()
    ...
    def __init__(self, client):
        super(Model_IsoImage, self).__init__(client)
