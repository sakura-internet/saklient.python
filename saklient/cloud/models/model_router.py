...
class Model_Router(Model):
    ...
    def _create_resource_impl(self, obj, wrapped=False):
        ...
        return Router(self._client, obj, wrapped)
    
    ## 次に取得するリストの開始オフセットを指定します。
    # 
    # @param {int} offset オフセット
    # @return {saklient.cloud.models.model_router.Model_Router} this
    ...
    # 
    # @return {saklient.cloud.resources.router.Router} リソースオブジェクト
    def create(self):
        return self._create()
    ...
    # 
    # @return {saklient.cloud.resources.router.Router[]} リソースオブジェクトの配列
    def find(self):
        return self._find()
    ...
    def __init__(self, client):
        super(Model_Router, self).__init__(client)
