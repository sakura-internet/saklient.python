...
class Model_Script(Model):
    ...
    def _create_resource_impl(self, obj, wrapped=False):
        ...
        return Script(self._client, obj, wrapped)
    
    ## 次に取得するリストの開始オフセットを指定します。
    # 
    # @param {int} offset オフセット
    # @return {saklient.cloud.models.model_script.Model_Script} this
    ...
    # 
    # @param {str} id
    # @return {saklient.cloud.resources.script.Script} リソースオブジェクト
    ...
    # 
    # @return {saklient.cloud.resources.script.Script[]} リソースオブジェクトの配列
    def find(self):
        return self._find()
    ...
    def __init__(self, client):
        super(Model_Script, self).__init__(client)
