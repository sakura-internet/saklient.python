...
class Model_Ipv6Net(Model):
    ...
    def _create_resource_impl(self, obj, wrapped=False):
        ...
        return Ipv6Net(self._client, obj, wrapped)
    
    ## 次に取得するリストの開始オフセットを指定します。
    # 
    # @param {int} offset オフセット
    # @return {saklient.cloud.models.model_ipv6net.Model_Ipv6Net} this
    ...
    # 
    # @param {str} id
    # @return {saklient.cloud.resources.ipv6net.Ipv6Net} リソースオブジェクト
