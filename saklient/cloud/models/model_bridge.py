...
class Model_Bridge(Model):
    ...
    def _create_resource_impl(self, obj, wrapped=False):
        ...
        return Bridge(self._client, obj, wrapped)
    
    ## 次に取得するリストの開始オフセットを指定します。
    # 
    # @param {int} offset オフセット
    # @return {saklient.cloud.models.model_bridge.Model_Bridge} this
    ...
    # 
    # @return {saklient.cloud.resources.bridge.Bridge} リソースオブジェクト
    def create(self):
        return self._create()
    ...
    # 
    # @return {saklient.cloud.resources.bridge.Bridge[]} リソースオブジェクトの配列
    def find(self):
        return self._find()
    ...
    def __init__(self, client):
        super(Model_Bridge, self).__init__(client)
