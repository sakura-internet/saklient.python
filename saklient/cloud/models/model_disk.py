...
class Model_Disk(Model):
    ...
    # @return {saklient.cloud.models.model_disk.Model_Disk} this
    ...
    # 
    # @return {saklient.cloud.resources.disk.Disk} リソースオブジェクト
    def create(self):
        return self._create()
    ...
    # 
    # @return {saklient.cloud.resources.disk.Disk[]} リソースオブジェクトの配列
    def find(self):
        return self._find()
