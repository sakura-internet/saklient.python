...
class Model_Server(Model):
    ...
    # @return {saklient.cloud.model.model_server.Model_Server} this
    ...
    # 
    # @return {saklient.cloud.resource.server.Server} リソースオブジェクト
    def create(self):
        return self._create()
    ...
    # 
    # @return {saklient.cloud.resource.server.Server[]} リソースオブジェクトの配列
    def find(self):
        return self._find()
    ...
    ## 指定したプランのサーバに絞り込みます。
    # 
    # @param {saklient.cloud.resource.serverplan.ServerPlan} plan
    # @return {saklient.cloud.model.model_server.Model_Server}
