...
from ..resource.iface import Iface
...
class Model_Iface(Model):
    ...
    # @return {saklient.cloud.model.model_iface.Model_Iface} this
    ...
    # 
    # @return {saklient.cloud.resource.iface.Iface} リソースオブジェクト
    def create(self):
        return self._create()
    ...
    # 
    # @return {saklient.cloud.resource.iface.Iface[]} リソースオブジェクトの配列
    def find(self):
        return self._find()
