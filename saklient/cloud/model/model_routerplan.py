...
from saklient.cloud.resource.routerplan import RouterPlan
...
class Model_RouterPlan(Model):
    ...
    # @return {saklient.cloud.model.model_routerplan.Model_RouterPlan} this
    ...
    # 
    # @param {str} id
    # @return {saklient.cloud.resource.routerplan.RouterPlan} リソースオブジェクト
    ...
    # 
    # @return {saklient.cloud.resource.routerplan.RouterPlan[]} リソースオブジェクトの配列
    def find(self):
        return self._find()
