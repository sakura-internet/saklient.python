...
class Model_Disk(Model):
    ...
    # @return {saklient.cloud.model.model_disk.Model_Disk} this
    ...
    # 
    # @return {saklient.cloud.resource.disk.Disk} リソースオブジェクト
    def create(self):
        return self._create()
    ...
    # 
    # @return {saklient.cloud.resource.disk.Disk[]} リソースオブジェクトの配列
    def find(self):
        return self._find()
