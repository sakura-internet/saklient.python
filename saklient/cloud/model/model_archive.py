...
class Model_Archive(Model):
    ...
    # @return {saklient.cloud.model.model_archive.Model_Archive} this
    ...
    # 
    # @return {saklient.cloud.resource.archive.Archive} リソースオブジェクト
    def create(self):
        return self._create()
    ...
    # 
    # @return {saklient.cloud.resource.archive.Archive[]} リソースオブジェクトの配列
    def find(self):
        return self._find()
