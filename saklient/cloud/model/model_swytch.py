...
from saklient.cloud.resource.swytch import Swytch
...
class Model_Swytch(Model):
    ...
    # @return {saklient.cloud.model.model_swytch.Model_Swytch} this
    ...
    # 
    # @return {saklient.cloud.resource.swytch.Swytch} リソースオブジェクト
    def create(self):
        return self._create()
    ...
    # 
    # @return {saklient.cloud.resource.swytch.Swytch[]} リソースオブジェクトの配列
    def find(self):
        return self._find()
