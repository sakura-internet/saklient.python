...
from ..resource.ipv6net import Ipv6Net
...
class Model_Ipv6Net(Model):
    ...
    # @return {saklient.cloud.model.model_ipv6net.Model_Ipv6Net} this
    ...
    # 
    # @param {str} id
    # @return {saklient.cloud.resource.ipv6net.Ipv6Net} リソースオブジェクト
    ...
    # 
    # @return {saklient.cloud.resource.ipv6net.Ipv6Net[]} リソースオブジェクトの配列
    def find(self):
        return self._find()
