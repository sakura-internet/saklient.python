...
class Model_IsoImage(Model):
    ...
    # @return {saklient.cloud.model.model_isoimage.Model_IsoImage} this
    ...
    # 
    # @return {saklient.cloud.resource.isoimage.IsoImage} リソースオブジェクト
    def create(self):
        return self._create()
    ...
    # 
    # @return {saklient.cloud.resource.isoimage.IsoImage[]} リソースオブジェクトの配列
    def find(self):
        return self._find()
