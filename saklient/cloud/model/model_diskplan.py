...
class Model_DiskPlan(Model):
    ...
    # @return {saklient.cloud.model.model_diskplan.Model_DiskPlan} this
    ...
    # 
    # @param {str} id
    # @return {saklient.cloud.resource.diskplan.DiskPlan} リソースオブジェクト
    ...
    # 
    # @return {saklient.cloud.resource.diskplan.DiskPlan[]} リソースオブジェクトの配列
    def find(self):
        return self._find()
