...
class DiskConfig:
    ...
    ## @return {saklient.cloud.resource.script.Script[]}
    ...
    # 
    # @param {saklient.cloud.resource.script.Script} script
    # @return {saklient.cloud.resource.diskconfig.DiskConfig} this
    def add_script(self, script):
        Util.validate_type(script, "saklient.cloud.resource.script.Script")
