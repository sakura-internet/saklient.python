...
class Iface(Resource):
    ...
    # 
    # @return {saklient.cloud.resource.iface.Iface} this
    def save(self):
        return self._save()
    ...
    def set_server_id(self, v):
        Util.validate_type(v, "str")
        if not self.is_new:
            raise SaklientException("immutable_field", "Immutable fields cannot be modified after the resource creation: " + "saklient.cloud.resource.iface.Iface#server_id")
        self.m_server_id = v
