...
class Swytch(Resource):
    ...
    # 
    # @return {saklient.cloud.resource.swytch.Swytch} this
    def save(self):
        return self._save()
    ...
    # @param {int} maskLen
    # @param {str} nextHop
    # @return {saklient.cloud.resource.ipv4net.Ipv4Net} 追加されたIPv4ネットワーク
    ...
    ## (This method is generated in Translator_default#buildImpl)
    # 
    # @return {saklient.cloud.resource.router.Router}
    def get_router(self):
    ...
    ## (This method is generated in Translator_default#buildImpl)
    # 
    # @return {saklient.cloud.resource.ipv4net.Ipv4Net[]}
    ...
    ## (This method is generated in Translator_default#buildImpl)
    # 
    # @return {saklient.cloud.resource.ipv6net.Ipv6Net[]}
