...
class Server(Resource):
    ...
    # 
    # @return {saklient.cloud.resource.server.Server} this
    def save(self):
        return self._save()
    ...
    # @param {(saklient.cloud.resource.server.Server, bool) => void} callback
    ...
    # 
    # @param {saklient.cloud.resource.serverplan.ServerPlan} planTo
    # @return {saklient.cloud.resource.server.Server} this
    def change_plan(self, planTo):
        Util.validate_type(planTo, "saklient.cloud.resource.serverplan.ServerPlan")
    ...
    # 
    # @return {saklient.cloud.resource.iface.Iface} 増設されたインタフェース
    def add_iface(self):
        model = Util.create_class_instance("saklient.cloud.model.Model_Iface", [self._client])
        res = model.create()
    ...
    ## サーバにISOイメージを挿入します。
    # 
    # @param {saklient.cloud.resource.isoimage.IsoImage} iso
    # @return {saklient.cloud.resource.server.Server} this
    ...
    ## (This method is generated in Translator_default#buildImpl)
    # 
    # @param {saklient.cloud.resource.serverplan.ServerPlan} v
    # @return {saklient.cloud.resource.serverplan.ServerPlan}
    def set_plan(self, v):
        Util.validate_type(v, "saklient.cloud.resource.serverplan.ServerPlan")
        if not self.is_new:
            raise SaklientException("immutable_field", "Immutable fields cannot be modified after the resource creation: " + "saklient.cloud.resource.server.Server#plan")
        self.m_plan = v
        self.n_plan = True
        return self.m_plan
    ...
    ## (This method is generated in Translator_default#buildImpl)
    # 
    # @return {saklient.cloud.resource.serverinstance.ServerInstance}
