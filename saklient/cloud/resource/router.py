...
class Router(Resource):
    ...
    # 
    # @return {saklient.cloud.resource.router.Router} this
    def save(self):
        return self._save()
    ...
    # @param {(saklient.cloud.resource.router.Router, bool) => void} callback
    # @return {void}
    ...
    # @return {Swytch}
    def get_swytch(self):
        model = Util.create_class_instance("saklient.cloud.model.Model_Swytch", [self._client])
        id = self.get_swytch_id()
        return model.get_by_id(id)
    
    ## このルータ＋スイッチでIPv6アドレスを有効にします。
    # 
    # @return {saklient.cloud.resource.ipv6net.Ipv6Net} 有効化されたIPv6ネットワーク
    ...
    # 
    # @param {saklient.cloud.resource.ipv6net.Ipv6Net} ipv6Net
    # @return {saklient.cloud.resource.router.Router} this
    def remove_ipv6_net(self, ipv6Net):
        Util.validate_type(ipv6Net, "saklient.cloud.resource.ipv6net.Ipv6Net")
    ...
    # @param {int} maskLen
    # @param {str} nextHop
    # @return {saklient.cloud.resource.ipv4net.Ipv4Net} 追加されたスタティックルート
    ...
    # 
    # @param {saklient.cloud.resource.ipv4net.Ipv4Net} ipv4Net
    # @return {saklient.cloud.resource.router.Router} this
    def remove_static_route(self, ipv4Net):
        Util.validate_type(ipv4Net, "saklient.cloud.resource.ipv4net.Ipv4Net")
    ...
    def set_network_mask_len(self, v):
        ...
        if not self.is_new:
            raise SaklientException("immutable_field", "Immutable fields cannot be modified after the resource creation: " + "saklient.cloud.resource.router.Router#network_mask_len")
    ...
    def set_band_width_mbps(self, v):
        Util.validate_type(v, "int")
        if not self.is_new:
            raise SaklientException("immutable_field", "Immutable fields cannot be modified after the resource creation: " + "saklient.cloud.resource.router.Router#band_width_mbps")
