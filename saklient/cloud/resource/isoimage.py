...
class IsoImage(Resource):
    ...
    # 
    # @return {saklient.cloud.resource.isoimage.IsoImage} this
    def save(self):
        return self._save()
    ...
    def set_size_mib(self, v):
        Util.validate_type(v, "int")
        if not self.is_new:
            raise SaklientException("immutable_field", "Immutable fields cannot be modified after the resource creation: " + "saklient.cloud.resource.isoimage.IsoImage#size_mib")
        self.m_size_mib = v
